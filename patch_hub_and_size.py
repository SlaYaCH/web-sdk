...
old_hub = "const HUB_Y = 151;"
new_hub = "const HUB_Y = 154;"

old_size = "const HEART_SIZE = 32;"
new_size = "const HEART_SIZE = 58;"
...
if missing:
    ...
    with open(path, "w") as f:
        f.write(content)
    print("OK : HUB_Y a 154 (baisse de 2%), coeurs exterieurs a x1.8 (58px).")
