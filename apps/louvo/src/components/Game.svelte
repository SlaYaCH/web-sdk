...
import DevRevealPanel from './DevRevealPanel.svelte';
	...
	import { texteSocial } from '../game/social';
...
<App>
	...
	{:else}
		...
		<DevRevealPanel />
		<FreeSpinIntro />
		<!-- Les compteurs etaient limites a desktop/landscape, donc absents
...
<div class="louvo-rules">
	...
	<p><strong>WILD-ONLY LINES.</strong> A WILD stands in for the symbol that continues the line. When a line begins with 3 or 4 WILDs and a DATE lands on the next reel, no regular symbol is left to stand in for: the line pays as 3 or 4 LE R, the highest paying symbol &mdash; 4.00x and 10.00x respectively. A full line of 5 WILDs always pays 20.00x.</p>
	...
	<h2>DISCLAIMER</h2>
	<p>All results are determined by the Remote Game Server before a round is displayed. The reel positions shown are illustrative: they present the result, they do not decide it. No event in the browser can influence the outcome of a round.</p>
